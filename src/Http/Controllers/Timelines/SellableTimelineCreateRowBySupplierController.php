...
class SellableTimelineCreateRowBySupplierController extends CRUD
{
	use CRUDCreateStoreTrait;

	public $allowedMethods = [
		'createRowFormBySupplier',
		'storeTimelineRow',
	];
	...
	{
		$file = cconfig('operators.models.orderrow.parametersFiles.timelineCreateBySupplier');
	...
	public function makeModel() : Model
	{
		...
		$orderrow->sellable_id = request()->sellable;

		return $orderrow;
	}

	public function createRowFormBySupplier(Request $request) : View
	{
		return $this->create();
	}
