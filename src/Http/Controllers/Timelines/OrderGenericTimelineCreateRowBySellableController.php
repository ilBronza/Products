...
class OrderGenericTimelineCreateRowBySellableController extends CRUD
{
	use CRUDCreateStoreTrait;

	public $allowedMethods = [
		'createRowFormByOrder',
		'storeTimelineRow',
	];
	...
	public function createRowFormByOrder(Request $request) : View
	{
		return $this->create();
	}
	...
	public function makeModel() : Model
	{
		...
		$orderrow->order_id = request()->input('group_id');
